...
<section class="jl-page-content blog blog-single blog-standard margin-100 margin-sm-50">
  ...
  <div class="row product-details">
                                    <div class="image-column col-md-6 col-sm-12">
                                        <figure class="image-box"><img src="../resources/img/burger-large.jpg" alt=""></figure>
                                    </div>
                                    <div class="info-column col-md-6 col-sm-12">
                                        <div class="details-header">
                                            <h4>Big Bite Burger</h4>
                                            <div class="rating">
                                        ...
                                        <div class="text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.

</div>
                                        <div class="other-options clearfix">
                                            <div class="form-group stepper-type">
                     <div class="stepper "><input class="form-control stepper-input" type="number" data-zeros="true" value="6" min="1" max="99"><span class="stepper-arrow up"></span><span class="stepper-arrow down"></span></div>
                  </div>

                                            <button type="button" class="btn"><span class="btn-title">Add To Cart</span></button>
                                        </div>
